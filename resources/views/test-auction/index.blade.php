    ...
    <body>
        <div class="container">
            <div class="row custom-auction">
               ...
               <div class="col-md-6">
                    <div class="action">
                        <p>product_name: {{$data->name}}</p>
                        <p class="time-left"> <strong>Time left:</strong> <span id="timelefthtml">{{ $data->time_auction}}<span></p> 
        ...
        <script>
          ...
          $(document).ready(function () {
              ...
              const urlHttp = 'http://127.0.0.1:8000';
              let urlGetData = 'http://127.0.0.1:8000/product'
              let step=0;
              let countdown = `{{ $data->time_auction}}`;
              ...
              {{-- setInterval(() => {
                   var time = new Date();
                    time.setSeconds(time.getSeconds() + 120);
                     console.log(time.getHours() + ":" + time.getMinutes() + ":" + time.getSeconds());
                 $("#timelefthtml").html(time.getSeconds());
              },0);
           --}}
